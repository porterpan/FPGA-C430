...
#define RXSTART_INIT   		0x0600	// give TX buffer space for one full ethernet frame (~1500 bytes)ENC28J60_BIT_FIELD_CLEAR
...
extern void enc28j60_phy_write(unsigned char address,unsigned short data);
extern void enc28j60_packet_send(unsigned short len,unsigned char * packet);
extern unsigned char enc28j60_read_control_register(unsigned char address);
extern unsigned int enc28j60_packet_receive(unsigned short maxlen,unsigned char * packet);
